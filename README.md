...
>  1. Polymorphic Stealth: Every component mutates per deployment.
>   2. Context-Aware Agility: Behavior adapts to the target environment in real-time.
>    3. Persistent Dominance: Once established, removal requires physical media destruction.
